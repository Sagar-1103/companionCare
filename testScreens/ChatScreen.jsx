...
const ChatScreen = ({ route }) => {
  ...
  const roomId = user.roomIds.doctorRoomId;
...
const handleImageUpload = (image) => {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    const socket = new WebSocket(`https://hot-poets-flow.loca.lt`);
    socket.onopen = () => {
...
const styles = StyleSheet.create({
  ...
  image: { width: 150, height: 150, borderRadius: 10, marginTop: 5, maxWidth: "100%", maxHeight: 160, objectFit: "cover"},
  inputContainer: {
    flexDirection: "row",
    alignItems: "center",
    padding: 10,
