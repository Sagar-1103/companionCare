...
const mockData = {
  '2025-02-19': { steps: 8104, calories: 850, distance: 5, duration: 120 },
  '2025-02-18': { steps: 7500, calories: 800, distance: 4.5, duration: 110 },
  '2025-02-17': { steps: 6543, calories: 700, distance: 4, duration: 100 },
  '2025-02-16': { steps: 2222, calories: 300, distance: 2, duration: 60 },
  '2025-02-15': { steps: 7865, calories: 820, distance: 5.2, duration: 125 },
  '2025-02-14': { steps: 8886, calories: 900, distance: 5.5, duration: 130 },
  '2025-02-13': { steps: 7522, calories: 780, distance: 4.8, duration: 115 },
  '2025-02-12': { steps: 7321, calories: 760, distance: 4.7, duration: 112 },
  '2025-02-11': { steps: 6543, calories: 700, distance: 4, duration: 100 },
  '2025-02-10': { steps: 7111, calories: 750, distance: 4.6, duration: 110 },
};
...
const WalkTrackerScreen = ({ route }) => {
  ...
  // Add a default value for healthDataHistory
  const { healthDataHistory = mockData } = route.params;
  ...
  // Ensure selectedDateData has default values if no data is found
  const selectedDateData = healthDataHistory[formatDate(selectedDate)] || {
    steps: 0,
    calories: 0,
    distance: 0,
    duration: 0,
